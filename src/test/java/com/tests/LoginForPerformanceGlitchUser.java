...
public class LoginForPerformanceGlitchUser extends BaseTest {

	List<String> login;

	@FrameworkAnnotation(author = "Poonam")
	@Test(description = "To validate login functionality for Performance Glitch user")
	public void loginForPerformanceGlitchUserTest() {

		try {
			login = ExcelUtils.readData("loginForPerformanceGlitchUserTest"); // pass test case name as an argument so
																				// that data
