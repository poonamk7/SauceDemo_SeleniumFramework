...
public class LoginForProblemUserTest extends BaseTest {

	List<String> login;

	@FrameworkAnnotation(author = "Poonam")
	@Test(description = "To validate login functionality for Problem user")
	public void loginForProblemUserTest() {
		...
		loginPage.performLogin(login.get(0), login.get(1)); // for get(index) --> index 0 starts from username column
															// and needs to be passed according to value
