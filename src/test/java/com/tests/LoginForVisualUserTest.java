...
public class LoginForVisualUserTest extends BaseTest {

	List<String> login;

	@FrameworkAnnotation(author = "Poonam")
	@Test(description = "To validate login functionality for Visual user")
	public void loginForVisualUserTest() {

		try {
			login = ExcelUtils.readData("loginForVisualUserTest"); // pass test case name as an argument so that data
